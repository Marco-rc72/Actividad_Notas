  ...
  <div class="min-h-screen bg-gray-50 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <header class="mb-12 text-center">
        ...
        <p class="text-gray-600">Organiza y gestiona tus tareas de manera eficiente.</p>
      </header>
      ...
      <div class="flex">
        <div class="mb-6">
          ...
          <select 
            ...
            class="mt-1 block w-fit px-4 py-2 border mr-10 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
          >
        ...
        <div class="mb-6">
          ...
          <select 
            ...
            class="mt-1 block w-fit px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
          >
      ...
      <div class="mb-6" v-if="etiquetaFiltro">
        <button 
          ...
          >
            <div class="p-6">
              ...
              <span 
                v-if="nota.tag"
                :class="{
                  'bg-blue-100 text-blue-800': nota.tag === 'Trabajo',
                  'bg-green-100 text-green-800': nota.tag === 'Personal',
                  'bg-red-100 text-red-800': nota.tag === 'Urgente',
                  'bg-gray-100 text-gray-800': !['Trabajo', 'Personal', 'Urgente'].includes(nota.tag)
                }" 
...
const { notas } = storeToRefs(notasStore)
...
const notasFiltradas = computed(() => {
  let notasFiltradas = notas.value
